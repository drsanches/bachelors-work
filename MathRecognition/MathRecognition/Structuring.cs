...
namespace MathRecognition
{
    ...
    {
        private const double SEARCH_TOP = 0.4; // Not for \frac and 0 positions (e.g. vectors)
        private const double SEARCH_DOWN = 0.4; // 
        private const double SEARCH_RIGHT = 1;
        private const double SEARCH_LEFT = 1;
        ...
        protected void AddInBaselines(Rectangle rectangle)
        {
        ...
        protected bool IsAtOneLine(Symbol s1, Symbol s2)
        {
